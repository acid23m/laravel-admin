...
return [
    ...
    'columns' => [
        'alpha' => [
            'rows' => ['name', 'username', 'title', 'description', 'text', 'email', 'slug'],
        ...
        'numeric' => [
            'rows' => ['id', 'created_at', 'updated_at', 'deleted_at', 'level'],
     ...
     */
    'default_icon_set' => 'fa fa-sort-amount',

    /**
     * icon that shows when generating sortable link while column is not sorted
     */
    'sortable_icon' => 'fa fa-arrows-alt-v',
