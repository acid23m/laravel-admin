...
class InstallCommandTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $node_version = 13;
        passthru('node -v', $v);
        if (!Str::startsWith($v, "v$node_version")) {
    ...
    public function testCommand(): void
    {
        ...
        $this->assertDirectoryExists($this->node_modules_path);
        $this->assertDirectoryExists($this->js_dist_path);
        $this->assertDirectoryExists($this->css_dist_path);
    }
